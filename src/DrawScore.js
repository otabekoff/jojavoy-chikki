function drawScore() {
    ...
    if (currentState == states.lost) {
        ...
        if (chicken.score > rank) {
            context.fillText("Yangi rekord!", -145, -65);
        }
        else if (rank < 10) {
            context.fillText("Eski Rekord " + rank, -155, -65);
        }
        else if (rank >= 10 && rank < 100) {
            context.fillText("Eski Rekord " + rank, -175, -65);
        } else {
            context.fillText("Eski Rekord " + rank, -190, -65);
        }
